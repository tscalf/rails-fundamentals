...
class GradesControllerTest < ActionController::TestCase
  ...
  test "should create grade" do
    assert_difference('Grade.count') do
      post :create, grade: { assignment: @grade.assignment, course: @grade.course, grade: @grade.grade, name: @grade.name }
    end
  ...
  test "should update grade" do
    patch :update, id: @grade, grade: { assignment: @grade.assignment, course: @grade.course, grade: @grade.grade, name: @grade.name }
    assert_redirected_to grade_path(assigns(:grade))
  end
